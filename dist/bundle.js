...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".myDiv{background-color:rgba(0,0,0,.4);color:#fff;font-weight:bold;position:absolute;top:30%;left:50%;transform:translate(-50%, -50%);z-index:2;width:80%;padding:20px;text-align:center}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./src/component/bio/style.scss
...
var update = injectStylesIntoStyleTag_default()(style/* default */.Z, options);
       ...
       /* harmony default export */ const bio_style = (style/* default */.Z && style/* default.locals */.Z.locals ? style/* default.locals */.Z.locals : undefined);
